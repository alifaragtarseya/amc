@php
    $title = $resource->id ? __('lang.edit') . ' ' . __('lang.product') : __('lang.add') . ' ' . __('lang.product');
@endphp
            ...
            <form class="form" action="{{ $resource->id ? route('admin.product.update', $resource->id) : route('admin.product.store') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 pt-3">
                        {!! Form::label('category_id', __('lang.categories') , ['class' => 'form-label'] ) !!} <br>
                        {!! Form::select('category_id', $categories, old('category_id',$resource->category_id), ['class' => 'form-control select-2 select2 p-2' ,'requried' , 'placeholder' => __('lang.select') . ' ' . __('lang.category')]) !!}

                    </div>
                    <div class="col-md-4 pt-3">
                        {!! Form::label('time', __('lang.time') , ['class' => 'form-label'] ) !!} <br>
                        {!! Form::text('url', old('url',$resource->url), ['class' => 'form-control']) !!}

                    </div>

                    <div class="col-md-4 pt-3">
                        {!! Form::label('customer_name', __('lang.customer_name') , ['class' => 'form-label'] ) !!} <br>
                        {!! Form::text('field', old('field',$resource->field), ['class' => 'form-control']) !!}
                    </div>
                    <div class="col-md-6 pt-3">
                        {!! Form::label('location', __('lang.location') , ['class' => 'form-label'] ) !!} <br>
                        {!! Form::text('country', old('country',$resource->country), ['class' => 'form-control']) !!}
                    </div>
                    <div class="col-md-6 pt-3">
                        {!! Form::label('mision', __('lang.mision') , ['class' => 'form-label'] ) !!} <br>
                        {!! Form::text('technology', old('technology',$resource->technology), ['class' => 'form-control']) !!}
                    </div>
                    <div class="clearfix"></div>
