        ...
        <form class="form" action="{{ $resource->id ? route('admin.counter.update', $resource->id) : route('admin.counter.store') }}"
            ...
            <div class="row">
                <div class="col-12  ">
                    ...
                    {!! Form::label('image', __('lang.image') , ['class' => 'form-label'] ) !!} <small class="text-danger">({{ __('lang.best_size') }} w:80 * h:80 ) </small> <br>
                    <img class=" image-preview-image m-auto rounded-circle" width="50" height="50"   src="{{ asset($resource->image ?? 'assets/img/default.jpg' ) }}">
                    <br>
                ...
                {{-- <div class="col-6  ">
                    ...
                    {!! Form::label('bg_hover', __('lang.bg_hover') , ['class' => 'form-label'] ) !!} <br>
                    <img class=" image-preview-bg_hover m-auto rounded-circle" width="80" height="80"   src="{{ asset($resource->bg_hover ?? 'assets/img/default.jpg' ) }}">
                    <br>
                    <label for="bg_hover"class="btn btn-primary text-white mt-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M13 19v-4h3l-4-5l-4 5h3v4z"/><path fill="currentColor" d="M7 19h2v-2H7c-1.654 0-3-1.346-3-3c0-1.404 1.199-2.756 2.673-3.015l.581-.102l.192-.558C8.149 8.274 9.895 7 12 7c2.757 0 5 2.243 5 5v1h1c1.103 0 2 .897 2 2s-.897 2-2 2h-3v2h3c2.206 0 4-1.794 4-4a4.01 4.01 0 0 0-3.056-3.888C18.507 7.67 15.56 5 12 5C9.244 5 6.85 6.611 5.757 9.15C3.609 9.792 2 11.82 2 14c0 2.757 2.243 5 5 5z"/></svg>
                    </label>

                    <input type="file"  onchange="changeImage(this, 'bg_hover')" id="bg_hover" class="d-none form-control mt-3" name="bg_hover" >
                </div> --}}
                <div class="col-12  ">
