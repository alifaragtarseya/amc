...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <form class="form" action="{{ $resource->id ? route('admin.tool.update', $resource->id) : route('admin.tool.store') }}"
            method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 text-center ">

                    {!! Form::label('image', __('lang.image') , ['class' => 'form-label'] ) !!} <small class="text-danger">({{ __('lang.best_size') }}w:140 * h:140)</small><br>
                    <img class=" image-preview-image  " width="140px" height="140px"   src="{{ asset($resource->image ?? 'assets/img/default.jpg' ) }}">
                    <br>
