...
class ProductController extends Controller
{
    ...
    public function store(StoreProduct $request)
    {
        ...
        if (isset($inputs['project_logo'])) {
            $inputs['project_logo'] = uploadImage( $inputs['project_logo'] , config('path.PRODUCTS_PATH'), 'logo');
        }
        DB::beginTransaction();
    ...
    public function update(StoreProduct $request, $id)
    {
        ...
        if (isset($inputs['project_logo'])) {
            $inputs['project_logo'] = uploadImage($inputs['project_logo'], config('path.PRODUCTS_PATH'),'logo', $resource->project_logo);
        }
        DB::beginTransaction();
    ...
    public function destroy($id)
    {
        ...
        deleteImage($resource->project_logo);
