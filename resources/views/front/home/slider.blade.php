            ...
            <div class="">
                <div class="row pt-5 mt-5">
                    <div class="col-md-6 p-5 ">
                        <div class="p-5 text-title-description-baner">

                            {{-- <span class="slider--span">{{ __('lang.hello_to_trust') }}</span> --}}

                            <div class="pt-3 {{!isMobile()?'slider--title':''}} title-slider-bg-screen" style="">
                                {!! $slider->title !!}
                            </div>
                            <p class="text-white title-slider-bg-screen">
                                {{ $slider->description }}
                            </p>

                            <br>
                            <a href="{{ route('front.service') }}" class="btn btn--custom btn-big-screen">
